...
# (  -0.00,  -50.00)->(  +0.00,  +50.00)
# (  +0.00,   +0.00)->(  +0.00,  +50.00)
# (  +0.00,  +50.00)->( -86.60,   +0.00)
# ( -86.60,   +0.00)->(  -0.00,  -50.00)
# (  -0.00,  -50.00)->(  -0.00,  +50.00)
# (  +0.00,   +0.00)->(  +0.00,  +50.00)
...
# (  -0.00,  -50.00)->(  +0.00,  +50.00)
# (  +0.00,   +0.00)->(  +0.00,  +50.00)
# (  +0.00,  +50.00)->( -95.11,  +80.90)
# ( -95.11,  +80.90)->(-153.88,   +0.00)
# (-153.88,   +0.00)->( -95.11,  -80.90)
# ( -95.11,  -80.90)->(  +0.00,  -50.00)
# (  +0.00,  -50.00)->(  +0.00,  +50.00)
# (  +0.00,   +0.00)->(  +0.00,  +50.00)
# (  +0.00,  +50.00)->( -86.60, +100.00)
# ( -86.60, +100.00)->(-173.21,  +50.00)
# (-173.21,  +50.00)->(-173.21,  -50.00)
# (-173.21,  -50.00)->( -86.60, -100.00)
# ( -86.60, -100.00)->(  -0.00,  -50.00)
# (  -0.00,  -50.00)->(  +0.00,  +50.00)
# (  +0.00,   +0.00)->(  +0.00,  +50.00)
# (  +0.00,  +50.00)->( -78.18, +112.35)
# ( -78.18, +112.35)->(-175.68,  +90.10)
# (-175.68,  +90.10)->(-219.06,   +0.00)
# (-219.06,   +0.00)->(-175.68,  -90.10)
# (-175.68,  -90.10)->( -78.18, -112.35)
# ( -78.18, -112.35)->(  -0.00,  -50.00)
# (  -0.00,  -50.00)->(  +0.00,  +50.00)
# """
#
# pup_ans = """\
# (+300.00,   +0.00)->(+300.00, +100.00)
# (+300.00, +100.00)->(+300.00,   +0.00)
# (+300.00,   +0.00)->(+213.40,  +50.00)
# (+213.40,  +50.00)->(+300.00, +100.00)
# (+300.00, +100.00)->(+300.00,   +0.00)
# (+300.00,   +0.00)->(+200.00,   -0.00)
# (+200.00,   -0.00)->(+200.00, +100.00)
# (+200.00, +100.00)->(+300.00, +100.00)
# (+300.00, +100.00)->(+300.00,   +0.00)
# (+300.00,   +0.00)->(+204.89,  -30.90)
# (+204.89,  -30.90)->(+146.12,  +50.00)
# (+146.12,  +50.00)->(+204.89, +130.90)
# (+204.89, +130.90)->(+300.00, +100.00)
# (+300.00, +100.00)->(+300.00,   -0.00)
# (+300.00,   -0.00)->(+213.40,  -50.00)
# (+213.40,  -50.00)->(+126.79,   -0.00)
# (+126.79,   -0.00)->(+126.79, +100.00)
# (+126.79, +100.00)->(+213.40, +150.00)
# (+213.40, +150.00)->(+300.00, +100.00)
# (+300.00, +100.00)->(+300.00,   +0.00)
# (+300.00,   +0.00)->(+221.82,  -62.35)
# (+221.82,  -62.35)->(+124.32,  -40.10)
# (+124.32,  -40.10)->( +80.94,  +50.00)
# ( +80.94,  +50.00)->(+124.32, +140.10)
# (+124.32, +140.10)->(+221.82, +162.35)
# (+221.82, +162.35)->(+300.00, +100.00)
# (+300.00, +100.00)->(+300.00,   +0.00)
# """
...
# (  +0.00,   -0.00)->(+100.00,   +0.00)
# (+100.00,   +0.00)->( +50.00,  -86.60)
# ( +50.00,  -86.60)->(  -0.00,   -0.00)
# (  -0.00,   -0.00)->(+100.00,   +0.00)
# (+100.00,   +0.00)->(+100.00, -100.00)
# (+100.00, -100.00)->(  +0.00, -100.00)
# (  +0.00, -100.00)->(  -0.00,   -0.00)
# (  -0.00,   -0.00)->(+100.00,   -0.00)
# (+100.00,   -0.00)->(+130.90,  -95.11)
# (+130.90,  -95.11)->( +50.00, -153.88)
# ( +50.00, -153.88)->( -30.90,  -95.11)
# ( -30.90,  -95.11)->(  -0.00,   -0.00)
# (  -0.00,   -0.00)->(+100.00,   -0.00)
# (+100.00,   -0.00)->(+150.00,  -86.60)
# (+150.00,  -86.60)->(+100.00, -173.21)
# (+100.00, -173.21)->(  +0.00, -173.21)
# (  +0.00, -173.21)->( -50.00,  -86.60)
# ( -50.00,  -86.60)->(  -0.00,   -0.00)
# (  -0.00,   -0.00)->(+100.00,   +0.00)
# (+100.00,   +0.00)->(+162.35,  -78.18)
# (+162.35,  -78.18)->(+140.10, -175.68)
# (+140.10, -175.68)->( +50.00, -219.06)
# ( +50.00, -219.06)->( -40.10, -175.68)
# ( -40.10, -175.68)->( -62.35,  -78.18)
# ( -62.35,  -78.18)->(  -0.00,   -0.00)
# """
...
def preprocess_segments(segments):
    ...
    while i < len(segments):
        ...
        while j < len(segments):
            ...
            # Если два отрезка коллиниарны и пересекаются, то заменяем их на один отрезок
            if abs(dx1 * dy2 - dy1 * dx2) < EPS:
                ...
                if max(fx1, tx1) >= min(fx2, tx2) and max(fx2, tx2) >= min(fx1, tx1) and \
                        max(fy1, ty1) >= min(fy2, ty2) and max(fy2, ty2) >= min(fy1, ty1):
                    # print(f'{i}-й и {j}-й пересекаются')
            ...
            i += 1
    if DEBUG:
        print('После склеивания до масштабирования:', segments)
